...
object AutoGenerateDocumentTitle {
    ...
    private fun generateTitle(hmsnrs: Set<String>, behovsmeldingType: BehovsmeldingType): String {
        ...
        val title = produkter
            .asSequence()
            .mapNotNull {
                // Tilbehør har ikke isoCategoryTitleShort-attributt, fordi et tilbehør kun kan identifiseres med de 4 første siffer i ISO-koden
                if (it.accessory && !it.isoCategoryTitle.isNullOrBlank()) {
                    "tilbehør til ${it.isoCategoryTitle}"
                } else {
                    it.isoCategoryTitleShort
                }
            }
