        ...
        runBlocking {
            ...
            try {
                ...
                val soknadData = SoknadData(
                    ...
                    kommunenavn = null,
                    soknadGjelder = AutoGenerateDocumentTitle.generateTitleForBehovsmelding(packet.behovsmelding),
                )

                logger.info { "Søknad med fullmakt mottatt: ${packet.behovsmeldingId}" }
                save(soknadData)
