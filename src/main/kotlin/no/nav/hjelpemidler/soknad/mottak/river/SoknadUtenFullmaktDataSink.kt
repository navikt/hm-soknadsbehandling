        ...
        runBlocking {
            withContext(Dispatchers.IO) {
                launch {
                    ...
                    try {
                        // Automatisk generer en dokumenttittel
                        val soknadGjelder = AutoGenerateDocumentTitle.generateTitle(packet.soknad)
                        logger.info("DEBUG: søknad gjelder generert tittel: $soknadGjelder")
