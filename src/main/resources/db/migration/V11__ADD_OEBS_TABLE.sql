...
(
    ...
    PRIMARY KEY (FNR_BRUKER, SOKNADS_ID, ORDRENR, ORDRELINJE, DELORDRELINJE)
);

CREATE INDEX V1_OEBS_DATA_FNR_BRUKER_ORDRE_IDX ON V1_OEBS_DATA (FNR_BRUKER);
CREATE INDEX V1_OEBS_DATA_ORDRELINJE_IDX ON V1_OEBS_DATA (SOKNADS_ID, FNR_BRUKER, ORDRENR, ORDRELINJE, DELORDRELINJE);
